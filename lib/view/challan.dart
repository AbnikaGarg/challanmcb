                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        if (controller.challanListData[index]
                                            .paymentReceiveTag!) {
