                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '${DateFormat("dd MMM yyyy").format(DateTime.parse(widget.data.createdDate!))}',
                                        style: GoogleFonts.inter(
                                          fontSize: 20,
                                          fontWeight: FontWeight.w400,
                                          fontStyle: FontStyle.normal,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        '${DateFormat("HH:mm a").format(DateTime.parse(widget.data.createdDate!))}',
                                        style: GoogleFonts.inter(
                                          fontSize: 20,
                                          fontWeight: FontWeight.w400,
                                          fontStyle: FontStyle.normal,
